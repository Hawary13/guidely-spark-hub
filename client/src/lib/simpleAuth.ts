...
export class SimpleAuthService {
  ...
  static async signIn(email: string, password: string): Promise<SimpleAuthResult> {
    try {
  ...
  // Sign out
  static async signOut(): Promise<SimpleAuthResult> {
    try {
  ...
  // Update user role
  static async updateUserRole(userId: string, role: User['role']): Promise<SimpleAuthResult> {
    try {
  ...
  static async resetPassword(email: string): Promise<SimpleAuthResult> {
    try {
      ...
      return { 
        success: true, 
        error: `Temporary password: ${tempPassword} (Check browser console - in production this would be emailed)` 
      };
    } catch (error: any) {
    ...
    switch (role) {
      ...
      case 'admin':
        return [
          ...
          'success-stories:read', 'success-stories:write'
        ];
      case 'editor':
        return [
          'pages:read', 'pages:write',
  ...
  static async initializeDefaultAdmin(): Promise<SimpleAuthResult> {
    try {
